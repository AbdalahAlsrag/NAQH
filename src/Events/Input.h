...
/*     Key_LOCKINGSCROLLLOCK = 132, */
    ...
    SDL_NUM_SCANCODES = 512 /**< not a key, just marks the number of scancodes
        ...
        bool KeyDown(Keys p_scanCode);
        bool KeyPressed(Keys p_scanCode);
        bool KeyReleased(Keys p_scanCode);

        bool MouseButtonDown(MouseButton p_button);
        bool MouseButtonPressed(MouseButton p_button);
        bool MouseButtonReleased(MouseButton p_button);
    ...
    private:
        ...
        Uint32 globalMouseState;
        Uint32 globalPrevMouseState;
        int mouseX, mouseY, globalMousex, globalMouseY;
    };
}}